...
DATE_FORMAT(E1.EVENT_TIMESTAMP,'YYYYMMddHH')    AS HOUR_ID,
COUNT(*)            	           AS MAIN_COUNT,
...
WHERE DATE_FORMAT(E1.EVENT_TIMESTAMP,'YYYYMMddHH') = '${hiveconf:DATE}'
GROUP BY 
...
DATE_FORMAT(E1.EVENT_TIMESTAMP,'YYYYMMddHH')
